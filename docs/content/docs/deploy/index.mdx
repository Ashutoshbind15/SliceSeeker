...
demo-search-ai is an **internal** stack. Do **not** publish admin-ui, indexer-api, tusd, or search-api to the public internet. There is no app-level login; network isolation is the security model.
