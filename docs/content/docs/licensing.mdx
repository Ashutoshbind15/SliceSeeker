...
Prefer versioned GHCR tags from the latest GitHub Release (currently `0.1.1`). The v0.1.0 admin UI image is missing Caddy Go-module license materials; a supplemental archive is attached to [that release](https://github.com/Ashutoshbind15/SliceSeeker/releases/tag/v0.1.0). New deployments should pull `0.1.1` or later.
