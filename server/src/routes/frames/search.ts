...
import { searchFrames } from "../../services/frames/search.js";

const DEFAULT_LIMIT = 10;

export const searchFramesHandler = async (req: Request, res: Response) => {
  ...
  try {
    const results = await searchFrames({ ...parsed.data, limit });
    res.json({
