...
/** Same stream-copy segmenter as multimodal chunking (keyframe-aligned cuts). */
export const segmentHybridVideoFile = async (input: {
  inputPath: string;
  extension: string;
  outputDir: string;
  ...
  await execFileAsync("ffmpeg", [
    ...
    "segment",
    "-segment_time",
    String(input.segmentDurationSec),
    "-reset_timestamps",
    "1",
    "-segment_list",
    segmentListPath,
